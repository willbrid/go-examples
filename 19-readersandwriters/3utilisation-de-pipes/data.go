...
/**
La fonction GenerateData définit un paramètre Writer, qu'elle utilise pour écrire des octets à partir d'une chaîne.

La fonction ConsumeData définit un paramètre Reader, qu'elle utilise pour lire des octets de données, lesquels sont ensuite utilisés pour
créer une chaîne.
**/
...
func GenerateDataImprove(writer io.Writer) {
	...
	Cela permet également de changer, dans la fonction `main` la goroutine afin qu'elle exécute la fonction `GenerateData` sans avoir
	besoin d'une fonction anonyme
	**/
