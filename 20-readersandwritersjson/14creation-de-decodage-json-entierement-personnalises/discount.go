...
/**
Cette implémentation de la méthode `UnmarshalJSON` utilise la méthode `Unmarshal` pour décoder les données JSON en une map, puis vérifie le type
de chaque valeur requise pour la structure `DiscountedProduct`.
**/
