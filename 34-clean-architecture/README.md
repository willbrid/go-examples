 ...
 **internal/dto et internal/events** : il s'agit des modèles de données utilisés pour la communication entrante et sortante avec les systèmes externes.

--- **internal/dto/** : c'est similaire avec les entités mais les différences sont : ne pas définir de **dto** dans **repository/**, les entités **dto** sont utiles pour obtenir le corps de notre requête, les paramètres de notre requête ou répondre avec nos données de notre API REST. <br>
